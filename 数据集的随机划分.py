...
if __name__ == "__main__":
    data_dir = r'E:\work\zhuanzhuzhilian\KMSN_Optical_flow_method\Dataset_create\crop_image/'  # 数据集目录
    proportion = [0.90, 0.10]  # 划分比例
    save_dir = r'E:\work\zhuanzhuzhilian\KMSN_Optical_flow_method\Dataset_create/'  # 保存路径
